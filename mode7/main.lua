...
function love.update(dt)
	...
	player.grid.x = math.floor(0+((player.location.realx / 50) )) if player.grid.x==0 then player.grid.x=1 end
	player.grid.y = math.floor(0+((player.location.realy / 60) )) if player.grid.y==0 then player.grid.y=1 end
	...
	if love.keyboard.isDown('w') or love.keyboard.isDown('a') or love.keyboard.isDown('s') or love.keyboard.isDown('d') then
		...
		elseif love.keyboard.isDown('w') then													--up
			...
			if player.location.y+mode7.y > screen.h/2-60 then
